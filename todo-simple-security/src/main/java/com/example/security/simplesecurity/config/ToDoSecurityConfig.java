...
import com.example.security.simplesecurity.directory.Person;
...
public class ToDoSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    public ToDoSecurityConfig(RestTemplateBuilder restTemplateBuilder, ToDoProperties toDoProperties) {
        ...
        this.restTemplate = restTemplateBuilder
                .basicAuthentication(
                        toDoProperties
                                .getUsername(), toDoProperties.getPassword()).build();
    }
                    ...
                    ResponseEntity<Resource<Person>> responseEntity = restTemplate
                            .exchange(
                                    RequestEntity.get(URI.create(builder.toUriString()))
                                            ...
                                            .build(), new ParameterizedTypeReference<Resource<Person>>() {
